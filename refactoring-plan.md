...
*   **✅ Actor Query Operations:** `face_actor` ✅, `animate_actor` ✅, `get_actor_moving` ✅, `get_actor_room` ✅, `get_actor_costume` ✅, `get_actor_walk_box` ✅, `get_actor_from_xy` ✅, `get_actor_elevation` ✅, `get_actor_width` ✅, `get_actor_scale_x` ✅, `get_actor_anim_counter` ✅
*   **Actor Movement Operations:** `walk_actor_to_obj`, `walk_actor_to`, `put_actor_at_xy`, `put_actor_at_object`, `actor_ops`, etc.
