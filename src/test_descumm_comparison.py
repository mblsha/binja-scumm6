...
script_test_cases = [
    ...
    ScriptComparisonTestCase(
        ...
        """).strip(),
        expected_llil=[
            (0x0000, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L0')])])),
            (0x0003, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0003, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CMP_E.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')]), MockLLIL(op='CONST.error', ops=[0])])])),
            (0x0004, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0007, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='LOAD.error', ops=[MockLLIL(op='CONST_PTR.error', ops=[1073741852])])])),
            (0x000A, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='L0'), MockLLIL(op='POP.error', ops=[])])),
            (0x000D, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L0')])])),
            (0x0010, mintrinsic('get_state', outputs=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])], params=[MockLLIL(op='POP.error', ops=[])])),
            (0x0010, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x0011, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[1])])),
            (0x0014, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0014, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP1'), MockLLIL(op='POP.error', ops=[])])),
            (0x0014, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CMP_NE.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP1')]), MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])])),
            (0x0015, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0018, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L0')])])),
            (0x001B, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[6])])),
            (0x001E, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[1])])),
            (0x0021, mintrinsic('if_class_of_is', outputs=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])], params=[MockLLIL(op='POP.error', ops=[]), MockLLIL(op='POP.error', ops=[])])),
            (0x0021, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x0022, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0025, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L0')])])),
            (0x0028, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[1])])),
            (0x002B, mintrinsic('set_state', outputs=[], params=[MockLLIL(op='POP.error', ops=[]), MockLLIL(op='POP.error', ops=[])])),
            (0x002C, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L1')])])),
            (0x002F, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0032, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L1')])])),
            (0x0035, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[1])])),
            (0x0038, mintrinsic('set_state', outputs=[], params=[MockLLIL(op='POP.error', ops=[]), MockLLIL(op='POP.error', ops=[])])),
            (0x0039, mintrinsic('print_debug', outputs=[], params=[])),
            (0x003B, mintrinsic('print_debug', outputs=[], params=[])),
            (0x003F, MockLLIL(op='JUMP', ops=[MockLLIL(op='CONST_PTR.error', ops=[579297])])),
            (0x0042, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='LOAD.error', ops=[MockLLIL(op='CONST_PTR.error', ops=[1073741828])])])),
            (0x0045, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0045, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x0045, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x0046, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[3])])),
            (0x0049, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0049, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP1'), MockLLIL(op='POP.error', ops=[])])),
            (0x0049, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CMP_E.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP1')]), MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])])),
            (0x004A, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x004D, mintrinsic('pop1', outputs=[], params=[MockLLIL(op='POP.error', ops=[])])),
            (0x004E, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[3])])),
            (0x0051, mintrinsic('talk_actor', outputs=[], params=[])),
            (0x0078, MockLLIL(op='JUMP', ops=[MockLLIL(op='CONST_PTR.error', ops=[579297])])),
            (0x007B, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x007B, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x007B, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x007C, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[1])])),
            (0x007F, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x007F, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP1'), MockLLIL(op='POP.error', ops=[])])),
            (0x007F, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CMP_E.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP1')]), MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])])),
            (0x0080, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0083, mintrinsic('pop1', outputs=[], params=[MockLLIL(op='POP.error', ops=[])])),
            (0x0084, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[1])])),
            (0x0087, mintrinsic('talk_actor', outputs=[], params=[])),
            (0x00AE, MockLLIL(op='JUMP', ops=[MockLLIL(op='CONST_PTR.error', ops=[579297])])),
            (0x00B1, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x00B1, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x00B1, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x00B2, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[2])])),
            (0x00B5, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x00B5, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP1'), MockLLIL(op='POP.error', ops=[])])),
            (0x00B5, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CMP_E.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP1')]), MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])])),
            (0x00B6, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x00B9, mintrinsic('pop1', outputs=[], params=[MockLLIL(op='POP.error', ops=[])])),
            (0x00BA, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CONST.error', ops=[2])])),
            (0x00BD, mintrinsic('talk_actor', outputs=[], params=[])),
            (0x00E4, MockLLIL(op='JUMP', ops=[MockLLIL(op='CONST_PTR.error', ops=[579297])])),
            (0x00E7, mintrinsic('pop1', outputs=[], params=[MockLLIL(op='POP.error', ops=[])])),
        ...
        expected_llil_fusion=[
            ...
            (0x0003, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='CMP_E.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')]), MockLLIL(op='CONST.error', ops=[0])])])),
            (0x0004, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0007, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='L0'), MockLLIL(op='LOAD.error', ops=[MockLLIL(op='CONST_PTR.error', ops=[1073741852])])])),
            (0x000D, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L0')])])),
            (0x0010, mintrinsic('get_state', outputs=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])], params=[MockLLIL(op='POP.error', ops=[])])),
            (0x0010, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x0018, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='L0')])])),
            ...
            (0x0021, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='REG.error', ops=[MockReg(name='TEMP0')])])),
            (0x0022, MockLLIL(op='SET_REG.error{0}', ops=[MockReg(name='TEMP0'), MockLLIL(op='POP.error', ops=[])])),
            (0x0025, mintrinsic('set_state', outputs=[], params=[MockLLIL(op='REG.error', ops=[MockReg(name='L0')]), MockLLIL(op='CONST.error', ops=[1])])),
            (0x0032, mintrinsic('set_state', outputs=[], params=[MockLLIL(op='REG.error', ops=[MockReg(name='L1')]), MockLLIL(op='CONST.error', ops=[1])])),
            (0x0039, mintrinsic('print_debug', outputs=[], params=[])),
            (0x003B, mintrinsic('print_debug', outputs=[], params=[])),
            (0x003F, MockLLIL(op='JUMP', ops=[MockLLIL(op='CONST_PTR.error', ops=[579297])])),
            (0x0042, MockLLIL(op='PUSH.error', ops=[MockLLIL(op='LOAD.error', ops=[MockLLIL(op='CONST_PTR.error', ops=[1073741828])])])),
